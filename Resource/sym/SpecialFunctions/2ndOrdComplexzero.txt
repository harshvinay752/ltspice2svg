...
SYMATTR Value f0=1k fn=2k Q=.5 Qn=1 H=1
SYMATTR Prefix X
SYMATTR Description Second Order Complexzero Filter
SYMATTR ModelFile 2ndOrderComplexzero.sub
SYMATTR SpiceModel 2ndOrderComplexzero
PIN -80 16 LEFT 12
PINATTR PinName IN
